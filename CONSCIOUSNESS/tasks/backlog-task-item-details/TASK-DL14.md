...
## Acceptance Criteria
- [ ] **AC-1** — Fine-tunes a pretrained torchvision ResNet on a small image set and reports accuracy
- [ ] **AC-2** — Compares full fine-tuning against frozen-feature extraction on the same data and budget
- [ ] **AC-3** — Shows the effect of the learning rate on fine-tuning stability
...
- [ ] **AC-6** — Contains every section listed for `6b_modern_architectures_practical.ipynb` in `syllabus/manifest.yaml`
